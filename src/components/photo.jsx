const ProfilePhoto = () => {
    return(
        ...
        <div className="w-[260px] h-[260px] group">
            ...
            <img src="profile.jpg" alt="profile_picture" width="240px" height="auto" className="ml-[15px] pt-[15px] group-hover:ml-[20px] group-hover:pt-[20px] duration-300 ease-in-out z-10 relative"/>
        </div>
    )
}
